...
print("Ce programme permet de résoudre les équations du second degré !")
...
print(f"\nVotre équation est {a}x\u00B2 + {b}x  + {c}  ")   # code Unicode x\u00B2 pour écrire x²
continuer = input("Appuyer sur 1 pour continuer , 0 sinon ")
while continuer == 0 :
    break
else :
    # traitement
